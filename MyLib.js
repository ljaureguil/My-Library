...
function gsubtract(fromob, ob) {
    var ob1 = fromob,//<script src="https://cdn.rawgit.com/ljaureguil/My-Library/7a86fc79/MyLib.js"></script>
...
function LJL() {
    ...
    this.loadScript = function(url, callback) {
        ...
        s.type = 'text/javascript';
        var code = loadDoc(url);
        t//<script src="https://cdn.rawgit.com/ljaureguil/My-Library/7a86fc79/MyLib.js"></script>
